...
from hrm.models import Employee,Company
from hrm.serializers import EmployeeSerializer,CompanySerializer
...
class CompanyDetail(APIView):
    ...
    def get_object(self, pk):
        try:
            return Company.objects.select_related('type').prefetch_related('product').get(pk=pk)
    ...
    def get(self, request, pk=None):
        if pk:
            ...
            employee = Company.objects.all().select_related('type').prefetch_related('product')
